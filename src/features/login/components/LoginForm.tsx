                ...
                <CardContent className="grid gap-6 relative px-8 pb-8">
                    ...
                    <div className="grid gap-3">
                        <div className="flex items-center justify-between">
                            ...
                            <a href="#" className="text-xs text-[#009B77] hover:text-[#00b388] transition-colors font-medium">
                    ...
                    <div className="text-center text-sm text-white/70 pt-3">
                        ¿No tienes una cuenta? <button onClick={onSignupClick} className="text-[#009B77] hover:text-[#00b388] font-semibold transition-colors">Regístrate aquí</button>
                    </div>
                </CardContent>
            </Card>
        </div>
