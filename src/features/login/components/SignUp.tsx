    ...
    return (
        <div className={cn("flex flex-col", className)} {...props}>
            ...
            <div className="mb-6">
                ...
                >
                    Regístrate gratis para explorar propiedades
                </motion.p>
            </div>
            ...
            {success && (
                <motion.div
                    initial={{ opacity: 0, y: -10 }}
                    animate={{ opacity: 1, y: 0 }}
                    className="bg-[#009B77]/10 border border-[#009B77]/20 text-[#009B77] px-4 py-3 rounded-xl text-sm mb-4"
                >
            ...
            >
                <Button
                    variant="outline"
                    className="h-11 bg-white/5 border-white/10 hover:bg-white/10 hover:border-white/20 text-white/80 hover:text-white transition-all duration-300 rounded-xl text-sm"
                >
            ...
            <form onSubmit={handleSubmit}>
                ...
                {/* Submit Button */}
                <motion.button
                    className="w-full h-11 mt-5 bg-gradient-to-r from-[#009B77] to-[#00b388] hover:from-[#00a883] hover:to-[#00c596] text-white font-semibold rounded-xl shadow-lg shadow-[#009B77]/25 hover:shadow-[#009B77]/40 transition-all duration-300 relative overflow-hidden group disabled:opacity-50 disabled:cursor-not-allowed"
            ...
            {/* Terms */}
            <motion.p
                className="mt-4 text-center text-xs text-white/30 leading-relaxed"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
